            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-dark py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0"><i class="fas fa-user-edit me-2"></i>Edit Staff Member</h4>
                        <div>
                            <span class="badge bg-light text-dark me-2">ID: {{ $staff->id }}</span>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror
                                <div class="mt-1">
                                    <a href="#" class="text-decoration-none small"><i class="fas fa-cog me-1"></i>Manage Staff Roles</a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('staff_payroll_branch_id') is-invalid @enderror" name="staff_payroll_branch_id" id="staff_payroll_branch_id" required>
                                    ...
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}" {{ old('staff_payroll_branch_id', $staff->staff_payroll_branch_id) == $branch->id ? 'selected' : '' }}>
                                            {{ $branch->branch_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select data-placeholder="Select Branches" class="form-control branches_select @error('access_branches') is-invalid @enderror" 
                                ...
                                @foreach($branches as $branch)
                                    <option value="{{ $branch->id }}" {{ in_array($branch->id, old('access_branches', $staff->access_branches ?? [])) ? 'selected' : '' }}>
                                        {{ $branch->branch_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="staff_firstname" class="form-control @error('staff_firstname') is-invalid @enderror" 
                                       id="staff_firstname" placeholder="First Name" value="{{ old('staff_firstname', $staff->staff_firstname) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="staff_lastname" class="form-control @error('staff_lastname') is-invalid @enderror" 
                                       id="staff_lastname" placeholder="Last Name" value="{{ old('staff_lastname', $staff->staff_lastname) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="staff_email" class="form-control @error('staff_email') is-invalid @enderror" 
                                       id="staff_email" placeholder="Email" value="{{ old('staff_email', $staff->staff_email) }}" required>
                                @error('staff_email')
                                    <div class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </div>
                        ...
                        <div class="section-header mb-4 mt-5">
                            ...
                            <p class="text-muted">Update staff preferences and settings</p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('staff_show_results') is-invalid @enderror" name="staff_show_results" id="staff_show_results">
                                <option value="20" {{ old('staff_show_results', $staff->staff_show_results ?? 20) == 20 ? 'selected' : '' }}>20</option>
                                <option value="50" {{ old('staff_show_results', $staff->staff_show_results) == 50 ? 'selected' : '' }}>50</option>
                                <option value="100" {{ old('staff_show_results', $staff->staff_show_results) == 100 ? 'selected' : '' }}>100</option>
                                <option value="250" {{ old('staff_show_results', $staff->staff_show_results) == 250 ? 'selected' : '' }}>250</option>
                                <option value="500" {{ old('staff_show_results', $staff->staff_show_results) == 500 ? 'selected' : '' }}>500</option>
                            </select>
                        ...
                        <!-- Status Section -->
                        <div class="section-header mb-4 mt-5">
                            <h5 class="text-primary mb-0"><i class="fas fa-user-check me-2 small"></i>Account Status</h5>
                            <p class="text-muted">Manage staff member account status</p>
                        </div>

                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="staff_status" name="staff_status" 
                                    {{ old('staff_status', $staff->staff_status) ? 'checked' : '' }} value="1">
                                <label class="form-check-label fw-semibold" for="staff_status">
                                    Active Staff Member
                                </label>
                            </div>
                            <small class="form-text text-muted">
                    ...
                    <div class="card-footer bg-light py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <a href="#" class="btn btn-outline-danger ms-2" data-bs-toggle="modal" data-bs-target="#deleteModal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete <strong>{{ $staff->staff_firstname }} {{ $staff->staff_lastname }}</strong>?</p>
                <p class="text-danger mb-0">This action cannot be undone and will permanently remove all staff data.</p>
            </div>
