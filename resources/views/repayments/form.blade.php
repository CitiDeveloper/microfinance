    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"
                        action="{{ isset($repayment) && $repayment->id ? route('repayments.update', $repayment->id) : route('repayments.store') }}">
                        @csrf
                        @if (isset($repayment) && $repayment->id)
                            @method('PUT')
                        @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('payment_date', optional($repayment->payment_date)->format('Y-m-d') ?? date('Y-m-d')) }}"
                                                    required>
                                                @error('payment_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select @error('status') is-invalid @enderror"
                                                    ...
                                                    <option value="pending"
                                                        {{ old('status', $repayment->status ?? '') == 'pending' ? 'selected' : '' }}>
                                                        Pending</option>
                                                    <option value="posted"
                                                        {{ old('status', $repayment->status ?? '') == 'posted' ? 'selected' : '' }}>
                                                        Posted</option>
                                                </select>
                                                @error('status')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="transaction_reference" class="form-label">Transaction
                                                    Reference</label>
                                                <input type="text"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="dea_cash_bank_account" class="form-label">Bank
                                                    Account</label>
                                                <select
                                                    class="form-select @error('dea_cash_bank_account') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="principal_paid" class="form-label">Principal Paid
                                                    *</label>
                                                <input type="number" step="0.01" min="0"
                                                    class="form-control @error('principal_paid') is-invalid @enderror"
                                                    id="principal_paid" name="principal_paid"
                                                    value="{{ old('principal_paid', $repayment->principal_paid ?? 0) }}"
                                                    required>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0"
                                                    ...
                                                    value="{{ old('interest_paid', $repayment->interest_paid ?? 0) }}"
                                                    required>
                                                @error('interest_paid')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0"><i class="fas fa-sticky-note me-2"></i>Additional
                                            Information</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="notes" class="form-label">Notes</label>
                                            <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="4">{{ old('notes', $repayment->notes ?? '') }}</textarea>
                                            @error('notes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="d-flex gap-2">
                                    <button type="submit"
                                        class="btn btn-{{ isset($repayment) ? 'warning' : 'primary' }}">
